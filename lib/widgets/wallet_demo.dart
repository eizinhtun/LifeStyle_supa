    ...
    return new Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          }, icon: Icon(Icons.filter_alt_rounded,size: 20,))
        ],

      ),

      body:StreamBuilder<QuerySnapshot>(
        stream: db.collection(transactions).doc(FirebaseAuth.instance.currentUser.uid).collection(manyTransaction).snapshots(),
                        ...
                        child: ListTile(
                          title: Column(
                            children: [
                              Row(
                                children: [
                                  item.type == TransactionType.Topup?Image.asset("assets/payment/topup.png",width: 50,height: 50,):Image.asset("assets/payment/withdraw.png",width: 50,height: 50,),
                                  Column(
                                  ...
                                  Text(
                                      ...
                                      style: TextStyle(fontSize: 14,color: item.type == TransactionType.Topup?Colors.green:Colors.red)
                                  ),
                                  IconButton(onPressed: (){
                              ...
                              Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text("Top up successful",style: TextStyle(fontSize: 13),),
                                    ],
                                  ),
                                  Spacer(),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5),
                                    child: Image.asset("assets/payment/success.png",width: 30,height: 30,),
                                  ),
                                ],
                              ),
                            ],
