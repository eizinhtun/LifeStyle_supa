    ...
    return Scaffold(
      ...
      body: Container(
        child: SmartRefresher(
          ...
          child: FutureBuilder(
            future: context.read<WalletProvider>().getManyTransactionList(context),
                        ...
                        child: ListTile(
                          title: Column(
                             children: [
                               Row(
                                 children: [
                                   snapshot.data[i].type == TransactionType.Topup?Image.asset("assets/payment/topup.png",width: 50,height: 50,):Image.asset("assets/payment/withdraw.png",width: 50,height: 50,),
                                   Column(
                                   ...
                                   Text(
                                       ...
                                       style: TextStyle(fontSize: 14,color: snapshot.data[i].type == TransactionType.Topup?Colors.green:Colors.red)
                                   ),
