...
class WalletState extends State<Wallet> {
  ...
  Widget build(BuildContext context) {
    ...
    //                               ),
    //                             ),
    //                             //Expanded(child: Icon(Icons.arrow_right,size: 25,))
    //                           ],
    //                         ),
    //                       ),
    //                       Container(
    ...
    //                             mainAxisAlignment: MainAxisAlignment.start,
    //                             children: [
    //                               Padding(padding: EdgeInsets.only(left: 20.0,top: 80.0)),
    ...
    //                             ElevatedButton(
    //                                 style: ElevatedButton.styleFrom(
    //                                     padding: EdgeInsets.only(left: 30, right: 30,top: 10,bottom: 10)// foreground
    //                                 ),onPressed: (){
    //
    //                             }, child: Text("Cash In")),
    //
