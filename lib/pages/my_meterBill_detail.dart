...
/*import 'package:episs/model/Consumer.dart';
import 'package:episs/model/StaticUser.dart';
import 'package:episs/utils/MyTheme.dart';
import 'package:episs/utils/meter_calculator.dart';*/
...
import 'package:left_style/models/meter_bill.dart';
  ...
  Widget _buildItem(rowIndex, colIndex, ColumSpan, text,) {
  ...
  Widget build(BuildContext context) {
    ...
    body:
     StreamBuilder<DocumentSnapshot>(
        stream:  db.collection(meterBillsCollection).doc(widget.docId).snapshots(),
          ...
          if(snapshot.hasData){
            ...
            return SingleChildScrollView(
              child: Container(
                ...
                padding: EdgeInsets.only(top: 10.0,left: 8.0,right: 8.0,bottom: 0.0),
                child: Stack(
                  children: [
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          width:
                          ScreenUtil().setSp(900), // 360.0,//double.infinity,jake
                        ...
                        Padding(
                          ...
                          child: Text(
                              (bill.refundAmount != null &&
                                  ...
                                  "   "
                                  : "") +bill.hotline, style: GetTextStyle()),
                        )
