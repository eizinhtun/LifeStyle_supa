...
class ChangePinEmailPage extends StatefulWidget {
  const ChangePinEmailPage({Key key}) : super(key: key);

  @override
  _ChangePinEmailPageState createState() => _ChangePinEmailPageState();
}

class _ChangePinEmailPageState extends State<ChangePinEmailPage> {
